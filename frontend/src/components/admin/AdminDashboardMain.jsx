...
import { MdBorderClear, MdOutlineProductionQuantityLimits } from "react-icons/md";
...
const AdminDashboardMain = () => {
    ...
    const adminEarning = adminOrders && adminOrders.reduce((acc,item) => acc + item.totalPrice * .03, 0);
                    ...
                    <div className="w-full p-4">
                        ...
                        <div className="w-full block 800px:flex items-center justify-between">
                            <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
                                ...
                                <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">GH₵ {adminBalance}</h5>
                            </div>
                            ...
                            <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
                                <div className="flex items-center">
                                    <MdOutlineProductionQuantityLimits size={30} className="mr-2" fill="#00000085"/>
                                    <h3 className={`${styles.productTitle} !text-[18px] leading-5 !font-[400] text-[#00000085]`}>
                                        All Orders
                                    </h3>
                                </div>
