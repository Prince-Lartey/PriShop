...
import Apple from "../../assets/sponsor/Apple.jpg"
import LG from "../../assets/sponsor/LG.jpg"
    ...
    return (
        <div className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl`}>
            <div className="flex justify-between w-full">
                ...
                <div className="flex items-start">
                    <img src={LG} style={{width:"150px", objectFit:"contain"}} alt="" />
                </div>
                <div className="flex items-start">
                    <img src={Apple} style={{width:"150px", objectFit:"contain"}} alt="" />
                </div>
                <div className="flex items-start">
