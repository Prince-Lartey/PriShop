        ...
        <div className={`py-4 min-h-screen ${styles.section}`}>
                ...
                <div key={index} className="w-full flex items-start mb-5">
                    ...
                    <div className="w-full">
                        ...
                        <h5 className="pl-3 text-[20px] text-[#00000091]">
                            GH₵ {item.discountPrice} x {item.qty}
                        </h5>
                    </div>
                ...
                <div className="w-full fixed top-0 left-0 h-screen bg-[#0005] z-50 flex items-center justify-center">
                    <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
                        ...
                        <div className="w-full flex">
                            <img src={`${selectedItem?.images[0].url}`} alt="" className="w-[100px]"/>
                            <div>
                        ...
                        <div className="w-full ml-3">
                            ...
                            <textarea name="comment" id="" cols="20" rows="5" value={comment} onChange={(e) => setComment(e.target.value)} placeholder="How was the product? Write your expression about it!" className="mt-2 w-[95%] border p-2 outline-none"></textarea>
                        </div>
                        <div className={`${styles.button} text-white text-[20px] ml-3`} onClick={rating > 1 ? reviewHandler : null} >Submit</div>
                    </div>
                </div>
            )}
            ...
            <div className="border-t w-full text-right">
                <h5 className="pt-3 text-[18px]">
                    Total Price: <strong>GH₵ {data?.totalPrice}</strong>
                </h5>
            </div>
            <br />
            <br />
            ...
            <div className="w-full 800px:flex items-center">
                <div className="w-full 800px:w-[60%]">
                    ...
                    <h4 className=" text-[20px]">{data?.shippingAddress.country}, {data?.shippingAddress.city}</h4>
